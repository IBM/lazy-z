...
import { paramTest, getType, arrTypeCheck, containsAny } from "./values.js";
    ...
    eachKey(params.schema, (formField) => {
      ...
      [
        ...
        if (params.schema[formField][formFieldItem]) {
          ...
          // set default to null
          componentStore[formField][formFieldItem] = isBoolean(
            params.schema[formField][formFieldItem],
          )
            ? params.schema[formField][formFieldItem]
...
export { createStore, storeTemplate, lazyZstate };
